    ...
    const sections = [
...

      {
        ...
        dataList: regimen ? [
          ...
          { name: 'Modalidad', value: regimen.modalidad ?? 'N/A' },
          { name: 'Especificidad', value: regimen.especificidad ?? 'N/A' },
          ...
          { name: 'F.O.T. Público TDP', value: regimen.fot_pub_tdp ?? 'N/A' },
          { name: 'F.O.T. Público Emi/Rec', value: regimen.fot_pub_emi_rec ?? 'N/A' },
          ...
          { name: 'Retiro de Basamento', value: regimen.r_basamento ?? 'N/A' },
          ...
          { name: 'Altura FOT Privado', value: regimen.h_fot_priv ?? 'N/A' },
          { name: 'Altura FOT Público', value: regimen.h_fot_pub ?? 'N/A' },
          { name: 'Altura FOT Basamento', value: regimen.h_fot_basamento ?? 'N/A' },
