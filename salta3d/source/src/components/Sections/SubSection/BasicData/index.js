            ...
            <Accordion sx={{ mt: 2, borderRadius: 2, '&:before': { display: 'none' }, border: '1px solid rgba(0,0,0,0.08)' }}>
              ...
              <AccordionDetails sx={{ p: 1 }}>
                <List size="small" disablePadding>
                  ...
                  {regimen.modalidad && (
                    <ListItem divider><ListItemText primary="Modalidad" secondary={regimen.modalidad} /></ListItem>
                  )}
                  {regimen.especificidad && (
                    <ListItem divider><ListItemText primary="Especificidad" secondary={regimen.especificidad} /></ListItem>
                  )}
                  ...
                  <ListItem divider><ListItemText primary="F.O.T. Público Creado" secondary={regimen.fot_publico || 'N/A'} /></ListItem>
                  {regimen.fot_pub_tdp && (
                    <ListItem divider><ListItemText primary="F.O.T. Público TDP" secondary={regimen.fot_pub_tdp} /></ListItem>
                  )}
                  {regimen.fot_pub_emi_rec && (
                    <ListItem divider><ListItemText primary="F.O.T. Público Emi/Rec" secondary={regimen.fot_pub_emi_rec} /></ListItem>
                  )}
                  ...
                  {regimen.r_basamento && (
                    <ListItem divider><ListItemText primary="Retiro de Basamento" secondary={regimen.r_basamento} /></ListItem>
                  )}
                  <ListItem divider><ListItemText primary="Altura Máxima" secondary={regimen.altura_maxima || 'N/A'} /></ListItem>
                  {regimen.h_fot_priv && (
                    <ListItem divider><ListItemText primary="Altura FOT Privado" secondary={regimen.h_fot_priv} /></ListItem>
                  )}
                  {regimen.h_fot_pub && (
                    <ListItem divider><ListItemText primary="Altura FOT Público" secondary={regimen.h_fot_pub} /></ListItem>
                  )}
                  {regimen.h_fot_basamento && (
                    <ListItem divider><ListItemText primary="Altura FOT Basamento" secondary={regimen.h_fot_basamento} /></ListItem>
                  )}
                  {regimen.plantas && (
