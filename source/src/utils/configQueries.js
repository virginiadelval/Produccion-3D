...
const defaultParcelLayers = {
  edif: {
    id: "edif_smp",
    source: {
      type: "vector",
      tiles: ["volumen_edif/{z}/{x}/{y}.pbf?optimize=true"],
      minzoom: 10,
      maxzoom: 18,
      cluster: false
    },
...
const defaultAlerts = [
  {
    id: "plusvalia_en_cero",
    title: "No se debe abonar plusvalía",
    text: ""
  },
  {
    id: "unidad_edificabilidad",
    title: "Parcela con más de una altura o Área Especial",
    text: "La altura podrá variar si: existe algún edificio lindero Catalogado o la altura del edificio lindero es mayor a la de la Unidad de Edificabilidad",
    article: []
  },
  {
    id: "afectaciones",
    title: "Afectaciones",
    text: "Este lote tiene afectaciones adicionales."
  },
  {
    id: "no_usos",
    title: "Sin Usos de Suelo",
    text: "Esta parcela no tiene usos de suelo asignados."
  }
];
...
const getAlert = (idAlert) =>
  (config.alerts || defaultAlerts).find(({ id }) => id === idAlert) || defaultAlerts.find(({ id }) => id === idAlert) || {}
...
const getParcel3D = () => (config.parcelLayers || defaultParcelLayers).edif_3D
...
const getParcelLayer = () => config.parcelLayers || defaultParcelLayers
